...
***** likely need to serialize a structure that has the size of each part
***** library does not control the contents of either the key or value
**** TODO Query iterator must split document key off of index value
